...
The following launch options (command line options) can be used to modify the behavior of the
game before it starts up. Most players will not need to use this feature, but it can be used to
automate things or help if the game doesn't start properly.
